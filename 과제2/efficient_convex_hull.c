...
t_line* upper_hull(t_point* points, int num_point, t_point p1, t_point pn, t_line* lines, int* num_line, int* capacity) {
	...
	int n11;
	separate_points(points, num_point, p1, points[maxIndex], s11, points, num_point, &n11);
	lines = upper_hull(s11, n11, p1, points[maxIndex], lines, num_line, capacity);

	t_point* s12 = (t_point*)malloc(sizeof(t_point) * num_point);
	int n12;
	separate_points(points, num_point, points[maxIndex], pn, s12, points, num_point, &n12);
	lines = upper_hull(s12, n12, points[maxIndex], pn, lines, num_line, capacity);
